...
with
    ...
    sq_stg_pol_lvl_covg_cml_agmt as (
        select
            ...
            sale_dt as sale_dt,
            pymt_pln_cd as pymt_pln_cd,
            mstr_pol_nbr as mstr_pol_nbr,
            tail_expi_dt as tail_expi_dt,
            src_mstr_pol_nbr as src_mstr_pol_nbr,
            src_pymt_pln_cd as src_pymt_pln_cd,
            src_ext_rpt_perd_dt as src_ext_rpt_perd_dt,
            cast(src_date as text) as src_date,
            polhldr_entprs_id as polhldr_entprs_id,
            polhldr_site_duns_nbr as polhldr_site_duns_nbr,
            parnt_child_contr_typ_cd as parnt_child_contr_typ_cd,
            pri_nmd_insd_fein_nbr as pri_nmd_insd_fein_nbr,
            ratg_bas_cd as ratg_bas_cd,
            src_mstr_pol_cd as src_mstr_pol_cd,
            wc_ratg_bas_cd as src_wc_ratg_bas_cd,
            zi_pol_sys_contr_id  /* NEW FIELDS */
            as zi_pol_sys_contr_id,
            cede_ptnr_ctry_anchr_id as cede_ptnr_ctry_anchr_id,
            assm_ptnr_ctry_pol_id as assm_ptnr_ctry_pol_id,
            assm_us_pol_nbr as assm_us_pol_nbr,
            frnt_cd as frnt_cd,
            drvd_contr_crcy_cd as drvd_contr_crcy_cd,
            non_renl_rsn_cd as non_renl_rsn_cd,
            src_ips_contr_id as src_ips_contr_id,
            src_ptnr_ctry_abbr as src_ptnr_ctry_abbr,
            src_ptnr_ctry_pol_id as src_ptnr_ctry_pol_id,
            src_ptnr_ctry_pol_nbr as src_ptnr_ctry_pol_nbr,
            src_frntg_cd as src_frntg_cd,
            src_non_renl_rsn_cd  /* Added as part of Surety Enablement */
            as src_non_renl_rsn_cd,
            genl_ln_of_busn_cd as genl_ln_of_busn_cd,
            frgn_prdr_cd  /* As part of CR 5964 - CR 6309             */
            as frgn_prdr_cd
        from
            (
                select
                    ca.cml_agmt_id as cml_agmt_id,
                    ca.agmt_anchr_id as agmt_anchr_id,
                    trim(ca.pol_nbr) as pol_nbr,
                    ca.pol_eff_dt as pol_eff_dt,
                    ca.typ_id as typ_id,
                    ca.actv_rec_ind as actv_rec_ind,
                    ca.inmy_agmt_anchr_id as inmy_agmt_anchr_id,
                    ca.acqn_cd as acqn_cd,
                    ca.adt_freq_cd as adt_freq_cd,
                    ca.bndl_cd as bndl_cd,
                    ca.can_dt as can_dt,
                    ca.can_rsn_cd as can_rsn_cd,
                    ca.ciid_match_ind as ciid_match_ind,
                    ca.cms_pty_id as cms_pty_id,
                    ca.cpan_ind as cpan_ind,
                    ca.cust_nbr as cust_nbr,
                    ca.dac_cd as dac_cd,
                    ca.divd_par_cd as divd_par_cd,
                    ca.exc_cd as exc_cd,
                    ca.instl_cd as instl_cd,
                    ca.modu_nbr as modu_nbr,
                    ca.mp_cd as mp_cd,
                    ca.plnd_end_dt as plnd_end_dt,
                    ca.pol_contr_typ_cd as pol_contr_typ_cd,
                    ca.pol_sym_cd as pol_sym_cd,
                    ca.port_ind as port_ind,
                    ca.pri_nmd_insd_nm as pri_nmd_insd_nm,
                    ca.prcg_ofc_cd as prcg_ofc_cd,
                    ca.prdr_src_cd as prdr_src_cd,
                    ca.ratg_ori_cd as ratg_ori_cd,
                    ca.reins_waqs_trty_cd as reins_waqs_trty_cd,
                    ca.renl_ind as renl_ind,
                    ca.retro_ratg_cd as retro_ratg_cd,
                    ca.rsk_typ_cd as rsk_typ_cd,
                    ca.self_insd_retn_ind as self_insd_retn_ind,
                    ca.sic_cd as sic_cd,
                    ca.src_pol_nbr as src_pol_nbr,
                    ca.src_pol_eff_dt as src_pol_eff_dt,
                    ca.src_pol_sym_cd as src_pol_sym_cd,
                    ca.sts_cd as sts_cd,
                    ca.undg_pgm_cd as undg_pgm_cd,
                    ca.v_inv_pool_ind as v_inv_pool_ind,
                    date(ca.eff_fm_tistmp) as eff_fm_tistmp,
                    date(ca.eff_to_tistmp) as eff_to_tistmp,
                    ca.bil_typ_cd as bil_typ_cd,
                    ca.incp_dt as incp_dt,
                    ca.agmt_term_in_mnth as agmt_term_in_mnth,
                    ca.contr_type_cd as contr_type_cd,
                    ca.mkt_cd as mkt_cd,
                    ca.perf_prot_ind as perf_prot_ind,
                    ca.sale_dt as sale_dt,
                    trim(ca.pymt_pln_cd) as pymt_pln_cd,
                    trim(ca.mstr_pol_nbr) as mstr_pol_nbr,
                    ca.tail_expi_dt as tail_expi_dt,
                    ...
                    src.wc_ratg_bas_cd as src_wc_ratg_bas_cd,
                    trim(ca.zi_pol_sys_contr_id) as zi_pol_sys_contr_id,  /* NEWFIELDS */
                    ...
                    trim(src.non_renl_rsn_cd) as src_non_renl_rsn_cd,  /* Added as part of Surety Enablement */
                    case
                        when
                ...
                from
                    ...
                    (
                        ...
                        from
                            (
                                select
                                    pol_nbr as cml_agmt_id,
                                    pol_eff_dt as agmt_anchr_id,
                                    mstr_pol_nbr as pol_nbr,
                                    pymt_pln_cd as pol_eff_dt,
                                    ext_rpt_perd_dt as typ_id,
                                    modu_nbr as actv_rec_ind,
                                    mstr_pol_cd as inmy_agmt_anchr_id,
                                    wc_ratg_bas_cd as acqn_cd,
                                    ips_contr_id as adt_freq_cd,
                                    ptnr_ctry_abbr as bndl_cd,
                                    ptnr_ctry_pol_id as can_dt,
                                    ptnr_ctry_pol_nbr as can_rsn_cd,
                                    frntg_cd as ciid_match_ind,
                                    non_renl_rsn_cd as cms_pty_id,
                                    row_number() over (
                ...
                where
                    ...
                    and ca.src_pol_eff_dt = cast(src.pol_eff_dt as text)
    ...
    shortcut_to_mplt_valdt_ctry_cd as ({{ shortcut_to_mplt_valdt_ctry_cd() }}),
    ...
    rtr_ins_upd as (
        ...
        ulkp_work_prcg_cyc_dt ulkp_work_prcg_cyc_dt__y
		on ulkp_work_prcg_cyc_dt__y.dummy=1
