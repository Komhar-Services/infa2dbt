{% macro shortcut_to_mplt_valdt_ctry_cd() -%}
    with
        ...
        exp_lkp_ctry_cd as (
            select
                ...
                -- (ISNULL(v_VALDT_PLC_ANCHR_ID_CTRY_CD)), '711',v_INVALID_CD = 1,
                -- 'null')
                decode(
                    true,
